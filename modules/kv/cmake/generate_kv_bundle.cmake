...
file(WRITE "${OUT}"
  "#ifndef EJS_KV_JS_BUNDLE_H\n#define EJS_KV_JS_BUNDLE_H\n\n#include <stddef.h>\n\n"
...
foreach(js_file IN LISTS js_files)
  ...
  set(symbol "ejs_kv_js_${js_identifier}")
...
file(APPEND "${OUT}"
  "static const EJSKVBundledScript ejs_kv_scripts[] = {\n"
  "${script_entries}"
  "};\n"
  "static const size_t ejs_kv_scripts_count = sizeof(ejs_kv_scripts) / sizeof(ejs_kv_scripts[0]);\n\n"
  "#endif /* EJS_KV_JS_BUNDLE_H */\n"
)
