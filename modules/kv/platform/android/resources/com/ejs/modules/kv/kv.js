(function() {
    ...
    function base64ToBytes(input) {
        ...
        for (let i = 0; i < clean.length;) {
            ...
            const b1 = alphabet.indexOf(c1);
            const b2 = alphabet.indexOf(c2);
            const b3 = c3 === "=" ? -1 : alphabet.indexOf(c3);
            const b4 = c4 === "=" ? -1 : alphabet.indexOf(c4);
            if (b1 < 0 || b2 < 0 || (c3 !== "=" && b3 < 0) || (c4 !== "=" && b4 < 0)) {
                throw new Error("Invalid base64 kv value");
            }
            bytes.push((b1 << 2) | (b2 >> 4));
            if (c3 !== "=") bytes.push(((b2 & 15) << 4) | (b3 >> 2));
            if (c4 !== "=") bytes.push(((b3 & 3) << 6) | b4);
        }
        return new Uint8Array(bytes);
    }
