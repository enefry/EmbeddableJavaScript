...
file(WRITE "${OUT}"
  "#ifndef EJS_PATH_JS_BUNDLE_H\n#define EJS_PATH_JS_BUNDLE_H\n\n#include <stddef.h>\n\n"
  "typedef struct {\n    const char *name;\n    const unsigned char *code;\n    size_t len;\n} EJSPathBundledScript;\n\n"
)
...
foreach(js_file IN LISTS js_files)
  ...
  set(symbol "ejs_path_js_${js_identifier}")
...
file(APPEND "${OUT}"
  "static const EJSPathBundledScript ejs_path_scripts[] = {\n"
  "${script_entries}"
  "};\n"
  "static const size_t ejs_path_scripts_count = sizeof(ejs_path_scripts) / sizeof(ejs_path_scripts[0]);\n\n"
  "#endif /* EJS_PATH_JS_BUNDLE_H */\n"
)
