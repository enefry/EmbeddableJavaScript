...
file(WRITE "${OUT}"
  "#ifndef EJS_FSWATCH_JS_BUNDLE_H\n#define EJS_FSWATCH_JS_BUNDLE_H\n\n#include <stddef.h>\n\n"
  "typedef struct {\n    const char *name;\n    const unsigned char *code;\n    size_t len;\n} EJSFSWatchBundledScript;\n\n"
)
...
foreach(js_file IN LISTS js_files)
  ...
  set(symbol "ejs_fswatch_js_${js_identifier}")
  execute_process(COMMAND "${XXD}" -i -n "${symbol}" "${INPUT_DIR}/${js_file}" RESULT_VARIABLE xxd_result OUTPUT_VARIABLE xxd_output ERROR_VARIABLE xxd_error)
...
file(APPEND "${OUT}"
  "static const EJSFSWatchBundledScript ejs_fswatch_scripts[] = {\n"
  "${script_entries}"
  "};\n"
  "static const size_t ejs_fswatch_scripts_count = sizeof(ejs_fswatch_scripts) / sizeof(ejs_fswatch_scripts[0]);\n\n"
  "#endif /* EJS_FSWATCH_JS_BUNDLE_H */\n"
)
