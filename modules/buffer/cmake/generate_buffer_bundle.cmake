...
file(WRITE "${OUT}"
  "#ifndef EJS_BUFFER_JS_BUNDLE_H\n#define EJS_BUFFER_JS_BUNDLE_H\n\n#include <stddef.h>\n\n"
  "typedef struct {\n    const char *name;\n    const unsigned char *code;\n    size_t len;\n} EJSBufferBundledScript;\n\n"
)
...
foreach(js_file IN LISTS js_files)
  ...
  set(symbol "ejs_buffer_js_${js_identifier}")
...
file(APPEND "${OUT}"
  "static const EJSBufferBundledScript ejs_buffer_scripts[] = {\n"
  "${script_entries}"
  "};\n"
  "static const size_t ejs_buffer_scripts_count = sizeof(ejs_buffer_scripts) / sizeof(ejs_buffer_scripts[0]);\n\n"
  "#endif /* EJS_BUFFER_JS_BUNDLE_H */\n"
)
