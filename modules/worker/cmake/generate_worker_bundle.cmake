...
file(WRITE "${OUT}"
  "#ifndef EJS_WORKER_JS_BUNDLE_H\n#define EJS_WORKER_JS_BUNDLE_H\n\n#include <stddef.h>\n\n"
  "typedef struct {\n    const char *name;\n    const unsigned char *code;\n    size_t len;\n} EJSWorkerBundledScript;\n\n"
)
...
foreach(js_file IN LISTS js_files)
  ...
  set(symbol "ejs_worker_js_${js_identifier}")
...
file(APPEND "${OUT}"
  "static const EJSWorkerBundledScript ejs_worker_scripts[] = {\n"
  "${script_entries}"
  "};\n"
  "static const size_t ejs_worker_scripts_count = sizeof(ejs_worker_scripts) / sizeof(ejs_worker_scripts[0]);\n\n"
  "#endif /* EJS_WORKER_JS_BUNDLE_H */\n"
)
