...
file(WRITE "${OUT}"
  "#ifndef EJS_XHR_JS_BUNDLE_H\n#define EJS_XHR_JS_BUNDLE_H\n\n#include <stddef.h>\n\n"
...
foreach(js_file IN LISTS js_files)
  ...
  set(symbol "ejs_xhr_js_${js_identifier}")
...
file(APPEND "${OUT}"
  "static const EJSXHRBundledScript ejs_xhr_scripts[] = {\n"
  "${script_entries}"
  "};\n"
  "static const size_t ejs_xhr_scripts_count = sizeof(ejs_xhr_scripts) / sizeof(ejs_xhr_scripts[0]);\n\n"
  "#endif /* EJS_XHR_JS_BUNDLE_H */\n"
)
