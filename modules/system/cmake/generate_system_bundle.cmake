...
file(WRITE "${OUT}"
  "#ifndef EJS_SYSTEM_JS_BUNDLE_H\n#define EJS_SYSTEM_JS_BUNDLE_H\n\n#include <stddef.h>\n\n"
  "typedef struct {\n    const char *name;\n    const unsigned char *code;\n    size_t len;\n} EJSSystemBundledScript;\n\n"
)
...
foreach(js_file IN LISTS js_files)
  ...
  set(symbol "ejs_system_js_${js_identifier}")
  execute_process(
...
file(APPEND "${OUT}"
  "static const EJSSystemBundledScript ejs_system_scripts[] = {\n"
  "${script_entries}"
  "};\n"
  "static const size_t ejs_system_scripts_count = sizeof(ejs_system_scripts) / sizeof(ejs_system_scripts[0]);\n\n"
  "#endif /* EJS_SYSTEM_JS_BUNDLE_H */\n"
)
