...
file(WRITE "${OUT}"
  "#ifndef EJS_WS_JS_BUNDLE_H\n#define EJS_WS_JS_BUNDLE_H\n\n#include <stddef.h>\n\n"
...
foreach(js_file IN LISTS js_files)
  ...
  set(symbol "ejs_ws_js_${js_identifier}")
...
file(APPEND "${OUT}"
  "static const EJSWSBundledScript ejs_ws_scripts[] = {\n"
  "${script_entries}"
  "};\n"
  "static const size_t ejs_ws_scripts_count = sizeof(ejs_ws_scripts) / sizeof(ejs_ws_scripts[0]);\n\n"
  "#endif /* EJS_WS_JS_BUNDLE_H */\n"
)
