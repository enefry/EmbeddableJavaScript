...
file(WRITE "${OUT}"
  "#ifndef EJS_WINTERTC_JS_BUNDLE_H\n#define EJS_WINTERTC_JS_BUNDLE_H\n\n#include <stddef.h>\n\n"
  "typedef struct {\n    const char *name;\n    const unsigned char *code;\n    size_t len;\n} EJSWinterTCBundledScript;\n\n"
)
...
foreach(js_file IN LISTS js_files)
  ...
  set(symbol "ejs_wintertc_js_${js_identifier}")
...
file(APPEND "${OUT}"
  "static const EJSWinterTCBundledScript ejs_wintertc_scripts[] = {\n"
  "${script_entries}"
  "};\n"
  "static const size_t ejs_wintertc_scripts_count = sizeof(ejs_wintertc_scripts) / sizeof(ejs_wintertc_scripts[0]);\n\n"
  "#endif /* EJS_WINTERTC_JS_BUNDLE_H */\n"
)
