...
file(WRITE "${OUT}"
  "#ifndef EJS_HASHING_JS_BUNDLE_H\n#define EJS_HASHING_JS_BUNDLE_H\n\n#include <stddef.h>\n\n"
  "typedef struct {\n    const char *name;\n    const unsigned char *code;\n    size_t len;\n} EJSHashingBundledScript;\n\n"
)
...
foreach(js_file IN LISTS js_files)
  ...
  set(symbol "ejs_hashing_js_${js_identifier}")
...
file(APPEND "${OUT}"
  "static const EJSHashingBundledScript ejs_hashing_scripts[] = {\n"
  "${script_entries}"
  "};\n"
  "static const size_t ejs_hashing_scripts_count = sizeof(ejs_hashing_scripts) / sizeof(ejs_hashing_scripts[0]);\n\n"
  "#endif /* EJS_HASHING_JS_BUNDLE_H */\n"
)
