...
file(WRITE "${OUT}"
  "#ifndef EJS_UUID_JS_BUNDLE_H\n#define EJS_UUID_JS_BUNDLE_H\n\n#include <stddef.h>\n\n"
  "typedef struct {\n    const char *name;\n    const unsigned char *code;\n    size_t len;\n} EJSUUIDBundledScript;\n\n"
)
...
foreach(js_file IN LISTS js_files)
  ...
  set(symbol "ejs_uuid_js_${js_identifier}")
...
file(APPEND "${OUT}"
  "static const EJSUUIDBundledScript ejs_uuid_scripts[] = {\n"
  "${script_entries}"
  "};\n"
  "static const size_t ejs_uuid_scripts_count = sizeof(ejs_uuid_scripts) / sizeof(ejs_uuid_scripts[0]);\n\n"
  "#endif /* EJS_UUID_JS_BUNDLE_H */\n"
)
