...
file(WRITE "${OUT}"
  "#ifndef EJS_SQLITE_JS_BUNDLE_H\n#define EJS_SQLITE_JS_BUNDLE_H\n\n#include <stddef.h>\n\n"
  "typedef struct {\n    const char *name;\n    const unsigned char *code;\n    size_t len;\n} EJSSQLiteBundledScript;\n\n"
)
...
foreach(js_file IN LISTS js_files)
  ...
  set(symbol "ejs_sqlite_js_${js_identifier}")
...
file(APPEND "${OUT}"
  "static const EJSSQLiteBundledScript ejs_sqlite_scripts[] = {\n"
  "${script_entries}"
  "};\n"
  "static const size_t ejs_sqlite_scripts_count = sizeof(ejs_sqlite_scripts) / sizeof(ejs_sqlite_scripts[0]);\n\n"
  "#endif /* EJS_SQLITE_JS_BUNDLE_H */\n"
)
