...
file(WRITE "${OUT}"
  "#ifndef EJS_FS_JS_BUNDLE_H\n#define EJS_FS_JS_BUNDLE_H\n\n#include <stddef.h>\n\n"
...
foreach(js_file IN LISTS js_files)
  ...
  set(symbol "ejs_fs_js_${js_identifier}")
...
file(APPEND "${OUT}"
  "static const EJSFSBundledScript ejs_fs_scripts[] = {\n"
  "${script_entries}"
  "};\n"
  "static const size_t ejs_fs_scripts_count = sizeof(ejs_fs_scripts) / sizeof(ejs_fs_scripts[0]);\n\n"
  "#endif /* EJS_FS_JS_BUNDLE_H */\n"
)
