...
file(WRITE "${OUT}"
  "#ifndef EJS_NET_JS_BUNDLE_H\n#define EJS_NET_JS_BUNDLE_H\n\n#include <stddef.h>\n\n"
...
foreach(js_file IN LISTS js_files)
  ...
  set(symbol "ejs_net_js_${js_identifier}")
...
file(APPEND "${OUT}"
  "static const EJSNetBundledScript ejs_net_scripts[] = {\n"
  "${script_entries}"
  "};\n"
  "static const size_t ejs_net_scripts_count = sizeof(ejs_net_scripts) / sizeof(ejs_net_scripts[0]);\n\n"
  "#endif /* EJS_NET_JS_BUNDLE_H */\n"
)
